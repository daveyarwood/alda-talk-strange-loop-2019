...
[.notes]
--
* TODO: put together example files
** alda-demos repo is a start
...
** Note length
*** Dots
*** Second/millisecond note lengths
...
* Other features
** (Can probably trim this down. Just want to quickly show that Alda can achieve
things that can't be easily expressed in standard musical notation.)
** Variables
** Alternate iterations

* Clojure expressions
** Basic translation / score DSL
** Do something cool with shuffle / seq fns
** Maybe leave it at that. Leave room for the v2 demo to be even cooler than
this one.
--
