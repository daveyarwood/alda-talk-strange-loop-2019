...
process, allowing you to hear the music that you're writing as you're writing
it.
...
and the command line to develop interactively.
** I believe that a tight feedback loop is essential to unlocking your
creativity when you're developing software, and the same principle applies when
you're composing music.
--
